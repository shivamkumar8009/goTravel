        ...
        <main className="mai">
          <section className="sec">
            ...
            <p className="parag" style={{ textAlign: "justify" }}>
              ...
              user-friendly, reliable, and constantly evolving to meet your
              needs. Join our community of passionate travelers and embark on a
              journey of a lifetime. Start planning your next adventure with
              goTravel today! Happy travels, The goTravel Team!
            </p>
          </section>
        </main>
      </div>
